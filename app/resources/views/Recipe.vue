            ...
            <div id="button-menu">
                <div class="row justify-content-md-center">
                    <div class="col-md-6 col-lg-4">
                        ...
                        <router-link to="/recipe/edit" tag="button" class="btn btn-default btn-block text-left mt-3">
                            <span class="fa fa-edit"></span>
                            <span class="left-spacing">Ein neues Rezept eingeben</span>
                        </router-link>
                        <router-link to="/recipe/rate" tag="button" class="btn btn-default btn-block text-left mt-3">
